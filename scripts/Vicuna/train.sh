...
python ./scripts/Vicuna/evaluate.py 0,1 12344 $t5_ratio $vit_ratio $kl_weight $prune_n $prune_m $max_train_samples $model_size $pruner $tune_opt $lora_r_v $lora_r_l $lora_r_q