...
class PeftModel(PushToHubMixin, torch.nn.Module):
    ...
    **Attributes**:
    ...
    def __init__(self, model, peft_config: PeftConfig):
        ...
        self.config = self.base_model.config if hasattr(self.base_model, "config") else None
...
class PeftModelForCausalLM(PeftModel):
    ...
    def __init__(self, model, peft_config: PeftConfig):
        ...
        self.base_model_prepare_inputs_for_generation = self.base_model.prepare_inputs_for_generation \
                                if hasattr(self.base_model, "prepare_inputs_for_generation") else None
...
class PeftModelForViT(PeftModel):
    ...
    def forward(self, image, sparse=False): 
        return self.base_model(image, sparse)
    
class PeftModelForQformer(PeftModel):
